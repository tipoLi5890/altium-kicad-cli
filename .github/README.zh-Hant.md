...
sheet**）、net 推論、ERC/power/BOM/diff/pinmap/intent 檢查、KiCad 寫入／繪製（18 種 op + 9 種巨集，
含 delete／move／rename、階層 add_sheet 與多單元放置、net-diff 安全護欄，輸出經 KiCad 自身 netlister 驗證）、
