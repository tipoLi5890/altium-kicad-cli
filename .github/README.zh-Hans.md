...
图纸**）、net 推断、ERC/power/BOM/diff/pinmap/intent 检查、KiCad 写入/绘制（18 种 op + 9 种宏，
含 delete/move/rename、层次 add_sheet 与多单元放置、net-diff 安全护栏，输出经 KiCad 自身 netlister 验证）、
